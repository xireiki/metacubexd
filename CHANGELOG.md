...
## [1.175.0](https://github.com/xireiki/metacubexd/compare/v1.174.0...v1.175.0) (2024-11-24)
...
* bump version ([64a2005](https://github.com/xireiki/metacubexd/commit/64a20050d9f07943a6671002fe7c8cc22092fe5f))
* bun -&gt; pnpm ([74ed544](https://github.com/xireiki/metacubexd/commit/74ed5448f4aca701f7e0e5f3013485ba449171b7))
* config for icon height and margin-right ([#1041](https://github.com/xireiki/metacubexd/issues/1041)) ([bf26a53](https://github.com/xireiki/metacubexd/commit/bf26a539bce4a995bf254f1653d98c3b5f1c0a22))
* **config:** check for frontend version update ([657c180](https://github.com/xireiki/metacubexd/commit/657c180e056e345776ac1a21966c4c3eafdb1d09))
* **config:** clear dns query results when input content gets cleared ([04cae65](https://github.com/xireiki/metacubexd/commit/04cae65805fac8102246f57aa438fc054bc68174))
* **config:** rearrange settings ([90c3d15](https://github.com/xireiki/metacubexd/commit/90c3d15616860c27c80b47e4190414a68ec395c2))
* **config:** refresh backend version after core gets updated ([73b7e3e](https://github.com/xireiki/metacubexd/commit/73b7e3e40a4a8ad18f5fece8260217ddb4bcfddb))
* **connections:** add isClosingConnections spinner ([23193c5](https://github.com/xireiki/metacubexd/commit/23193c5c98e41cc73250c4567f2558ee6f8943fb))
* **connections:** enable autoCloseConns by default ([dfcc750](https://github.com/xireiki/metacubexd/commit/dfcc750a1231d2614b5db92619bd71b89661cacc))
* **connections:** reduce default visible columns ([ca9e3ba](https://github.com/xireiki/metacubexd/commit/ca9e3ba57e4849c7349c8ff4fab018989b057d10))
...
* dual column for proxies render ([#1152](https://github.com/xireiki/metacubexd/issues/1152)) ([96869c9](https://github.com/xireiki/metacubexd/commit/96869c96c6291456b0720a5248f2cf7fe5630c48))
* embed fira sans web font ([b3ed3b5](https://github.com/xireiki/metacubexd/commit/b3ed3b50a5a074a7a30b754c8fa235bb63ca09cc))
* hidden api & remove domain unmaintained ([#939](https://github.com/xireiki/metacubexd/issues/939)) ([bd65478](https://github.com/xireiki/metacubexd/commit/bd6547873fcc64a500eadda78a1607be59e11a97))
...
* make persisted for ipv6 result ([#983](https://github.com/xireiki/metacubexd/issues/983)) ([2078051](https://github.com/xireiki/metacubexd/commit/2078051d7c8433ceda4240d41952cff32308990c))
* modes list for sing-box offical ([#1182](https://github.com/xireiki/metacubexd/issues/1182)) ([1ca89fb](https://github.com/xireiki/metacubexd/commit/1ca89fb6c736bcdb4d4b84552828fc7df3fa131d))
* optimize setup form ([#960](https://github.com/xireiki/metacubexd/issues/960)) ([00ab6d4](https://github.com/xireiki/metacubexd/commit/00ab6d46458c20d41b8b8080a8f57736d600d8d0))
* pin packageManager version ([a8cf520](https://github.com/xireiki/metacubexd/commit/a8cf520b5a516198c5552e4442cf2a4ef37b5441))
* preview dlspeed in proxies page ([#924](https://github.com/xireiki/metacubexd/issues/924)) ([51a88b5](https://github.com/xireiki/metacubexd/commit/51a88b506c1c4a5c41ff9a5c0e12a630f82a79fe))
* **proxies:** add multi-column render back ([9f7f8d0](https://github.com/xireiki/metacubexd/commit/9f7f8d0161103c222747b4d65f330057edd87d81))
* **proxies:** add proxy latency test history timeline ([1e7dcb1](https://github.com/xireiki/metacubexd/commit/1e7dcb13bc212c1b2e717bbaa72e9583edce41f4))
* **proxies:** add render in two columns option back ([1fd22d3](https://github.com/xireiki/metacubexd/commit/1fd22d3ece0905f1f22acb94d7d6a7a86a7a31e9))
* **proxies:** add subtle padding between title and footer ([e7ef8b3](https://github.com/xireiki/metacubexd/commit/e7ef8b373587c791283e6aaf8c11c3d0bb19367b))
* **proxies:** adjust collapsible grid columns ([3d1a234](https://github.com/xireiki/metacubexd/commit/3d1a2349780f780976192ed8cc06ada6b46c069b))
* **proxies:** display specialTypes on mobile in title ([0973686](https://github.com/xireiki/metacubexd/commit/09736863dfb7ca8738e70a0460ea401630182dab))
* **proxies:** drop ipv6 latency test & display ([cdd60cf](https://github.com/xireiki/metacubexd/commit/cdd60cfc37999da0f04bb7d286d8edd55f841dcb))
* **proxies:** gradient gradient gradient ([ca13549](https://github.com/xireiki/metacubexd/commit/ca1354943450bc927b508df9fac935047cb30d42))
* **proxies:** mount tooltip portal within rootElement ([554b361](https://github.com/xireiki/metacubexd/commit/554b3611844f355347ee99466c879fba035610cc))
* **proxies:** overhaul the look of proxies page, drop renderInTwoColumns support ([698362f](https://github.com/xireiki/metacubexd/commit/698362f1c7b31837ac60bdfde7aac1deccb2ea35))
* **proxies:** replace gradient with pure background color ([e273439](https://github.com/xireiki/metacubexd/commit/e273439f688790f5ced9f0fac9f2ac5d7064650e))
* **proxies:** show latency result only when possible ([4314e64](https://github.com/xireiki/metacubexd/commit/4314e64785a2caa5f1dbdb2896f2b28af8716f41))
* **proxies:** update layout, disable twemoji font by default ([3d8fa08](https://github.com/xireiki/metacubexd/commit/3d8fa080c351fa155c8c0edc7e4f6fee06438693))
* proxy group icon ([#1023](https://github.com/xireiki/metacubexd/issues/1023)) ([0b1d472](https://github.com/xireiki/metacubexd/commit/0b1d472d62734cba0bb75efa6acc787957b571c6))
* proxy type support i18n ([#1135](https://github.com/xireiki/metacubexd/issues/1135)) ([b0f32b5](https://github.com/xireiki/metacubexd/commit/b0f32b5e5583ca673ade44bbbe058900b4630a74))
...
* reconnect ws when logs level changed ([#1003](https://github.com/xireiki/metacubexd/issues/1003)) ([246a1ac](https://github.com/xireiki/metacubexd/commit/246a1ac053ef56a1930d3ad2ae3bd0784e01c513))
* release ([da417aa](https://github.com/xireiki/metacubexd/commit/da417aa5745e12771aa7df2999e7ea90a8b27932))
* **rules:** search input align with tabs ([ab018c5](https://github.com/xireiki/metacubexd/commit/ab018c529dea2f5af14cdd8b6724c01cecbbf59c))
* show current page title, closes [#474](https://github.com/xireiki/metacubexd/issues/474) ([9c76d7f](https://github.com/xireiki/metacubexd/commit/9c76d7ff76886495208809d3e0f2efc6e90de2f3))
* Support dynamic acquisition of clash_mode ([#908](https://github.com/xireiki/metacubexd/issues/908)) ([341a14a](https://github.com/xireiki/metacubexd/commit/341a14a7bcdf6054fb3bb8f1d6bb87e78cc38db7))
* support to set icon color to the theme color when proxy icon starts with `data:image/svg+xml` ([#1166](https://github.com/xireiki/metacubexd/issues/1166)) ([29ed55c](https://github.com/xireiki/metacubexd/commit/29ed55cf50298578a9fa92a209a1c9f70882ea43))
* trigger release ([2df7158](https://github.com/xireiki/metacubexd/commit/2df7158f8a1a5b3e81e0ffd68eb1918582002d62))
...
* **config:** missing translation for running mode ([705f651](https://github.com/xireiki/metacubexd/commit/705f6513469466ac74c137f396c135b31da31804))
* **config:** mode select options are missing ([21a3aa1](https://github.com/xireiki/metacubexd/commit/21a3aa169ed3fe53f04a97c806ef20a11120fdea))
* **config:** options are not getting reflected in fav light/dark theme select, closes [#1079](https://github.com/xireiki/metacubexd/issues/1079) ([ae1158d](https://github.com/xireiki/metacubexd/commit/ae1158d9577f3e4c9bf6efe5fb2737065559f777))
* **config:** selected option ([d6ce137](https://github.com/xireiki/metacubexd/commit/d6ce1376a67bdd8b439730505563084cb1ba082e))
...
* Fix the available update indicator causing horizontal overflow on mobile. ([#1153](https://github.com/xireiki/metacubexd/issues/1153)) ([ff41847](https://github.com/xireiki/metacubexd/commit/ff41847fd933e64e30c6f7b501e720e0d2fc5158))
...
* I18n unable to get value for name ([f19e700](https://github.com/xireiki/metacubexd/commit/f19e700f16095d62c232d1044ac610bfbe32e81f))
* **i18n:** time locale not working ([e6fa749](https://github.com/xireiki/metacubexd/commit/e6fa749a28e55b9ea85a5ccae71346823fd2567c))
* improve readability for dlspeed preview ([#932](https://github.com/xireiki/metacubexd/issues/932)) ([3727122](https://github.com/xireiki/metacubexd/commit/3727122b95cde32ef15d7383fa8d9eee98dfd5f0))
...
* **proxies:** double specialType if statement ([0c004be](https://github.com/xireiki/metacubexd/commit/0c004be98f062f79806a4ef95949f380d17571e1))
* **proxies:** prevent proxyName from overflowing ([4037597](https://github.com/xireiki/metacubexd/commit/40375979b8d1328ba3dde5e0a61d24271dfd4b3e))
* **proxies:** proxy type should be positioned relative to the card ([78ec9e5](https://github.com/xireiki/metacubexd/commit/78ec9e5d6c574e85405f7138782f39cce3a8a345))
* **proxies:** set break all on proxy name ([a31d2e8](https://github.com/xireiki/metacubexd/commit/a31d2e8d148c81f93b82d6bce55b0fff7410f61d))
* proxy group ipv6 test failed ([#996](https://github.com/xireiki/metacubexd/issues/996)) ([c43b84b](https://github.com/xireiki/metacubexd/commit/c43b84b1149939bf604e6798931f221fa191bc6b))
* **pwa:** items in includeAssets cannot be empty string ([ab794e7](https://github.com/xireiki/metacubexd/commit/ab794e73e3fce6de51485aa1837344117941fc9f))
...
* **rules:** restore name display ([cdef0e8](https://github.com/xireiki/metacubexd/commit/cdef0e8355fe0c25ee35d1345d54fda050f1fece))
* **rules:** text spacing of `updated at` ([342119e](https://github.com/xireiki/metacubexd/commit/342119e01e5a4fe02ca6cb68902d08d52f36c486))
* set latency for test failed ([#948](https://github.com/xireiki/metacubexd/issues/948)) ([9189bf5](https://github.com/xireiki/metacubexd/commit/9189bf5efb0676a053981e0ffd3b3c21f8332dcf))
